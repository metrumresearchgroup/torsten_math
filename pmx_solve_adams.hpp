 ...
 */
  ...
  auto pmx_solve_adams(const F& f, const int nCmt,
                      Ts... args) {
    return PMXSolveODE<dsolve::PMXOdeIntegrator<dsolve::PMXCvodesFwdSystem_adams, dsolve::PMXCvodesIntegrator>>::solve(f, nCmt, args...);
}
 ...
 */
  ...
  auto pmx_solve_adams(const F& f, const int nCmt,
                      Ts... args) {
    return PMXSolveODE<dsolve::PMXOdeIntegrator<dsolve::PMXCvodesFwdSystem_adams, dsolve::PMXCvodesIntegrator>>::solve(f, nCmt, args..., nullptr);
}
  ...
  auto pmx_solve_group_adams(const F& f, const int nCmt,
    ...
    return PMXSolveGroupODE<dsolve::PMXOdeIntegrator<dsolve::PMXCvodesFwdSystem_adams, dsolve::PMXCvodesIntegrator>>::solve(f, nCmt, len, args...);
  }
  ...
  auto pmx_solve_group_adams(const F& f, const int nCmt,
                            const std::vector<int>& len, Ts... args) {
    return PMXSolveGroupODE<dsolve::PMXOdeIntegrator<dsolve::PMXCvodesFwdSystem_adams, dsolve::PMXCvodesIntegrator>>::solve(f, nCmt, len, args..., nullptr);
  }
