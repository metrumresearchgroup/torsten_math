#ifndef STAN_MATH_TEST_FIXTURE_ODE_STIFF_C1_HPP
#define STAN_MATH_TEST_FIXTURE_ODE_STIFF_C1_HPP
...
struct stiff_c1_base {
  struct stiff_c1_rhs {
    ...
    Eigen::Matrix<stan::return_type_t<T1, T2>, -1, 1> operator()(const T0& t_in, const T1& y, std::ostream* msgs,
      ...
      auto& b = theta[1];
      auto& c = theta[2];
      res(0) = -y(0) + y(1) * y(1) + y(2) * y(2) + y(3) * y(3);
      res(1) = -a * y(1) + a * (y(2) * y(2) + y(3) * y(3));
      res(2) = -b * y(2) + b * y(3) * y(3);
      res(3) = -c * y(3) + 2.0;
      return res;
    }
  };
...
template <typename T>
struct stiff_c1_benchmark_tolerance_1_test : public stiff_c1_base<T>,
                                             public ODEBenchmarkFixture<stiff_c1_benchmark_tolerance_1_test<T>> {
  stiff_c1_benchmark_tolerance_1_test() {
    this -> rtol = 1.e-3;
    this -> atol = 1.e-3;
  }
};
...
template <typename T>
struct stiff_c1_benchmark_tolerance_2_test : public stiff_c1_base<T>,
                                             public ODEBenchmarkFixture<stiff_c1_benchmark_tolerance_2_test<T>> {
  stiff_c1_benchmark_tolerance_2_test() {
    this -> rtol = 1.e-6;
    this -> atol = 1.e-6;
  }
};
...
template <typename T>
struct stiff_c1_benchmark_tolerance_3_test : public stiff_c1_base<T>,
                                             public ODEBenchmarkFixture<stiff_c1_benchmark_tolerance_3_test<T>> {
  stiff_c1_benchmark_tolerance_3_test() {
    this -> rtol = 1.e-8;
    this -> atol = 1.e-8;
  }
};
...
template <typename T>
struct stiff_c1_benchmark_tolerance_4_test : public stiff_c1_base<T>,
                                             public ODEBenchmarkFixture<stiff_c1_benchmark_tolerance_4_test<T>> {
  stiff_c1_benchmark_tolerance_4_test() {
    this -> rtol = 1.e-12;
    this -> atol = 1.e-12;
  }
};
