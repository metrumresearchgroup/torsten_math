...
TORSTEN_DEF_ODE_SOLVER_FUNCTOR(pmx_ode_dirk4, torsten::pmx_ode_dirk4);
TORSTEN_DEF_ODE_SOLVER_FUNCTOR(pmx_ode_dirk3, torsten::pmx_ode_dirk3);
TORSTEN_DEF_ODE_SOLVER_FUNCTOR(pmx_ode_dirk2, torsten::pmx_ode_dirk2);
