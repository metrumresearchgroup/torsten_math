#ifndef STAN_MATH_TEST_FIXTURE_ODE_STIFF_E3_HPP
#define STAN_MATH_TEST_FIXTURE_ODE_STIFF_E3_HPP
...
struct stiff_e3_base {
  ...
  stiff_e3_base() : nested(),
                    f(), s1(), s2(),
                    y0(3),
                    theta{55, 65, 0.0785, 0.1},
                    t0(0),
                    ts{500},
                    rtol(1.e-6),
                    atol(1.e-6),
...
template <typename T>
struct stiff_e3_benchmark_tolerance_1_test : public stiff_e3_base<T>,
                                             public ODEBenchmarkFixture<stiff_e3_benchmark_tolerance_1_test<T>> {
  stiff_e3_benchmark_tolerance_1_test() {
    this -> rtol = 1.e-3;
    this -> atol = 1.e-3;
  }
};
...
template <typename T>
struct stiff_e3_benchmark_tolerance_2_test : public stiff_e3_base<T>,
                                             public ODEBenchmarkFixture<stiff_e3_benchmark_tolerance_2_test<T>> {
  stiff_e3_benchmark_tolerance_2_test() {
    this -> rtol = 1.e-6;
    this -> atol = 1.e-6;
  }
};
...
template <typename T>
struct stiff_e3_benchmark_tolerance_3_test : public stiff_e3_base<T>,
                                             public ODEBenchmarkFixture<stiff_e3_benchmark_tolerance_3_test<T>> {
  stiff_e3_benchmark_tolerance_3_test() {
    this -> rtol = 1.e-8;
    this -> atol = 1.e-8;
  }
};
...
template <typename T>
struct stiff_e3_benchmark_tolerance_4_test : public stiff_e3_base<T>,
                                             public ODEBenchmarkFixture<stiff_e3_benchmark_tolerance_4_test<T>> {
  stiff_e3_benchmark_tolerance_4_test() {
    this -> rtol = 1.e-12;
    this -> atol = 1.e-12;
  }
};
